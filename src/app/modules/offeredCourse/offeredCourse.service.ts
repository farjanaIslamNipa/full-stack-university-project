...
const createOfferedCourseIntoDB = async (payload: TOfferedCourse) => {
  ...
  const ifDepartmentBelongToFaculty = await AcademicDepartment.findOne({
  ...
  if (!ifDepartmentBelongToFaculty) {
    throw new AppError(
      ...
      `This ${isAcademicDepartmentExists.name} does not belongs to ${isAcademicFacultyExists.name} faculty`,
    );
  }
